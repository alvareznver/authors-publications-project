...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePublicationNotFoundException(PublicationNotFoundException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handlePublicationValidationException(PublicationValidationException ex) {
        log.error("Publication validation error: {}", ex.getMessage());
        Map<String, Object> response = buildErrorResponse(
